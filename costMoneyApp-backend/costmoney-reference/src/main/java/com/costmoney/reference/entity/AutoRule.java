...
public class AutoRule {
    ...
    @Column private String period = "daily";
    @Column(name = "interval_days") private int intervalDays = 1;
    ...
    public int getIntervalDays() { return intervalDays; } public void setIntervalDays(int intervalDays) { this.intervalDays = intervalDays; }
